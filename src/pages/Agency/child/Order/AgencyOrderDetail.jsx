...
const AgencyOrderDetail = ({ setTabActive }) => {
  ...
  const CustomerInfo = () => {
    return (
      <div>
        <span>Khách hàng: {orderInfo.info.customer?.name} </span>
        <br />
        <span>SĐT khách hàng: {orderInfo.info.customer_address?.phone}</span>
        <br />
        ...
        <TestScreenStyles>
          <div className="container">
            ...
            <div className="container_item1">
              ...
              <h4>Hoa hồng: {formatPrice(orderInfo.info.share_agency)}</h4>
            </div>
          </div>
        </TestScreenStyles>
      </React.Fragment>
