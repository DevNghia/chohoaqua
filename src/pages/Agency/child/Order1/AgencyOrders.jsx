...
const AgencyOrders = ({ setTabActive }) => {
  ...
  //   exportToExcel(yourData, "filename");
  // };
        ...
        <table className="order__table">
          ...
          {account.agency_type.is_general_agency === true ? (
            <tbody>
              {(orders?.data ?? []).map(
                (v, i) =>
                  v.customer.is_agent_have_general_agency === false &&
                  ...
                  v.line_items_at_time.length > 0 && (
                    <tr key={i}>
                      ...
                      <td className="status">
                        {formatPrice(v.share_general_agency)}
                ...
                (v, i) =>
                  ...
                  v.line_items_at_time.length > 0 && (
                    <tr key={i}>
                      ...
                      <td className="status">
                        {/* {v.agency_ctv_by_customer_referral_id == profile.id
                          ? formatPrice(v.share_agency_referen)
                          : formatPrice(v.share_agency)} */}
                        {v.share_agency_referen === null
                          ? formatPrice(v.share_agency)
                          : formatPrice(v.share_agency_referen)}
                      </td>
                    </tr>
